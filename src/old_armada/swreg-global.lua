...
local CMD_MESHES = {
    CUSTOM_ASSETS.."misc/command-dials/aim.jpg", --aim
    CUSTOM_ASSETS.."misc/command-dials/attack.jpg", --attack
    CUSTOM_ASSETS.."misc/command-dials/dodge.jpg", --dodge
    CUSTOM_ASSETS.."misc/command-dials/move.jpg"} --move

    local CMD_NAMES = {}
CMD_NAMES[CUSTOM_ASSETS.."misc/command-dials/aim.jpg"] = "Aim" --aim
CMD_NAMES[CUSTOM_ASSETS.."misc/command-dials/attack.jpg"] = "Attack" --attack
CMD_NAMES[CUSTOM_ASSETS.."misc/command-dials/dodge.jpg"] = "Dodge" --dodge
CMD_NAMES[CUSTOM_ASSETS.."misc/command-dials/move.jpg"] = "Move" --move

    local CMD_COLORS = {}
CMD_COLORS[CUSTOM_ASSETS.."misc/command-dials/aim.jpg"] = {0.4,0.8,0.4} --aim
CMD_COLORS[CUSTOM_ASSETS.."misc/command-dials/attack.jpg"] = {0.8,0.4,0.4} --attack
CMD_COLORS[CUSTOM_ASSETS.."misc/command-dials/dodge.jpg"] = {0.2, 0.4, 0.8} --dodge
CMD_COLORS[CUSTOM_ASSETS.."misc/command-dials/move.jpg"] = {0.8,0.4,0.8} --move
